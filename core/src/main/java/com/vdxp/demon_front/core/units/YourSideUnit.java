...
public abstract class YourSideUnit extends FriendlyUnit {
    ...
    public YourSideUnit(final Registry r, final float maxHp, final TextureAtlas spritesAtlas, final int spriteId, final float animationSpeed, final int xTile, final int yTile) {
		super(r, maxHp, spritesAtlas);
